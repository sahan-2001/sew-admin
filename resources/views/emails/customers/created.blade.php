...
<style>
    * { margin:0; padding:0; box-sizing:border-box; }
    ...
    .customer-details { background:#f1f5f9; border-radius:10px; padding:25px; margin-bottom:30px; }
...
<div class="email-container">
    ...
    <div class="content">
        <h1 class="welcome-text">Welcome, {{ $customer->name }}!</h1>
        <p class="intro">
            We are thrilled to welcome you as an official customer in {{ $companyDetails['name'] ?? 'Company Name' }}. 
            You can now access your orders, invoices, and payment details through our portal.
        </p>
        
        <div class="customer-details">
            <h2 class="details-title">Your Customer Details</h2>
            ...
            <div class="detail-item">
                ...
                <span class="detail-value">{{ $customer->phone_1 }}</span>
            </div>
            @endif
            @if($customer->phone_2)
            <div class="detail-item">
                <span class="detail-label">Secondary Phone:</span>
                <span class="detail-value">{{ $customer->phone_2 }}</span>
            </div>
            @endif
        </div>
        ...
        <div class="cta-section">
            ...
            <p class="cta-text">Log in to your customer portal to manage orders and track payments.</p>
            <a href="#" class="cta-button">Access Customer Portal</a>
        </div>
        ...
        <div class="next-steps">
            ...
            <div class="step">
                ...
                <p class="step-text">Our team will contact you within 2 business days regarding your account setup.</p>
            </div>
            <div class="step">
                <div class="step-number">2</div>
                <p class="step-text">You will receive your first invoice and order notifications via email and portal.</p>
            </div>
            <div class="step">
                <div class="step-number">3</div>
                <p class="step-text">Manage your invoices and payments directly through the portal for convenience.</p>
            </div>
        </div>

        <div class="contact-section">
            <h2 class="contact-title">Need Assistance?</h2>
            <p class="contact-info">Our Customer Support Team is here to help you</p>
    ...
    <div class="footer">
        ...
        <p class="copyright">This email was sent to {{ $customer->email }} as a registered customer.</p>
    </div>
</div>
</body>
</html>
