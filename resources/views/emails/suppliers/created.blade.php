...
<style>
    * { margin:0; padding:0; box-sizing:border-box; }
    ...
    /* Email Header */
    .header { background:linear-gradient(135deg, #2563eb 0%, #1e40af 100%); padding:25px; text-align:center; color:white; }
    .logo { font-size:28px; font-weight:700; margin-bottom:10px; display:inline-block; }
    .tagline { font-size:16px; opacity:0.9; margin-bottom:5px; }
    ...
    .supplier-details { background:#f1f5f9; border-radius:10px; padding:25px; margin-bottom:30px; }
    .details-title { font-size:18px; font-weight:600; margin-bottom:15px; color:#1e293b; }
    .detail-item { display:flex; margin-bottom:12px; }
    .detail-label { font-weight:500; min-width:120px; color:#475569; }
...
<div class="email-container">
    ...
    <div class="content">
        <h1 class="welcome-text">Welcome, {{ $supplier->name }}!</h1>
        <p class="intro">
            We are thrilled to welcome you as an official supplier partner in {{ $companyDetails['name'] ?? 'Company Name' }}. 
            Your products/services will play a vital role in our supply chain, and we look forward 
            to building a successful, long-term relationship with your organization.
        </p>
        
        <div class="supplier-details">
            <h2 class="details-title">Your Supplier Details</h2>
            ...
            <div class="detail-item">
                ...
                <span class="detail-value">{{ $supplier->shop_name }}</span>
            </div>
            <div class="detail-item">
            ...
            <div class="detail-item">
                ...
                <span class="detail-value">{{ $supplier->phone_1 }}</span>
            </div>
            @endif
            @if($supplier->phone_2)
            <div class="detail-item">
                <span class="detail-label">Secondary Phone:</span>
                <span class="detail-value">{{ $supplier->phone_2 }}</span>
            </div>
            @endif
            <div class="detail-item">
                <span class="detail-label">Status:</span>
                <span class="detail-value" style="color:#16a34a;">Approved & Active</span>
            </div>
        </div>

        <div class="cta-section">
            <h2 class="cta-title">Ready to Get Started?</h2>
            <p class="cta-text">Access our supplier portal to view upcoming orders, submit invoices, and track payments.</p>
            <a href="#" class="cta-button">Access Supplier Portal</a>
        </div>
        ...
        <div class="next-steps">
            ...
            <div class="step">
                ...
                <p class="step-text">Our procurement team will contact you within 2 business days to discuss upcoming requirements.</p>
            </div>
            <div class="step">
                <div class="step-number">2</div>
                <p class="step-text">You'll receive your first purchase order via email and through the supplier portal.</p>
            </div>
            <div class="step">
                <div class="step-number">3</div>
                <p class="step-text">Submit your invoices through the portal for faster processing and payments.</p>
            </div>
        </div>

        <div class="contact-section">
            <h2 class="contact-title">Need Assistance?</h2>
            <p class="contact-info">Our Supplier Relations Team is here to help you</p>
    ...
    <div class="footer">
        ...
        <p class="copyright">© 2023 GlobalTech Solutions. All rights reserved.</p>
        <p class="copyright">This email was sent to {{ $supplier->email }} as a registered supplier.</p>
    </div>
</div>
</body>
</html>
