...
class NonInventoryItemVatGroups extends Page implements HasForms, HasTable
{
    ...
    protected static string $view =
        'filament.resources.vat-group-resource.pages.non-inventory-item-vat-groups';
    ...
    protected function getHeaderActions(): array
    {
        return [
            Action::make('create')
                ->label('Create Non-Inventory Item VAT Group')
                ->icon('heroicon-o-plus')
                ->modalHeading('Create Non-Inventory Item VAT Group')
                ->form($this->getFormSchema())
                ->action(fn (array $data) =>
                    NonInventoryItemVatGroup::create($data)
                ),
        ];
    }
    ...
    {
        return $table
            ->query(NonInventoryItemVatGroup::query())
    ...
    protected function getFormSchema(): array
    {
        return [
            Forms\Components\TextInput::make('code')
                ...
                ->required()
                ->unique(
                    NonInventoryItemVatGroup::class,
                    'code',
                    ignoreRecord: true
                )
                ->maxLength(50),
