...
use App\Filament\Resources\AdditionalOrderExpenseResource\Pages;
use App\Models\AdditionalOrderExpense;
...
class AdditionalOrderExpenseResource extends Resource
{
            ...
            Section::make('Expence Details')
                ...
                ->schema([
                    Forms\Components\TextInput::make('amount')
                        ...
                        ->numeric()
                        ->prefix('Rs.')
                        ->helperText('Your amount will be added to the remaining balance of the order, You can receive the amount in customer invoice payment option.'),
    ...
    {
        return [
            'index' => Pages\ListAdditionalOrderExpenses::route('/'),
            'create' => Pages\CreateAdditionalOrderExpense::route('/create'),
            'edit' => Pages\EditAdditionalOrderExpense::route('/{record}/edit'),
        ];
    }
}
