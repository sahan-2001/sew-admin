...
class PurchaseQuotationItem extends Model
{
    ...
    protected static function booted()
    {
        ...
        static::saved(function ($model) {
            if ($model->purchaseQuotation) {
                $model->purchaseQuotation->recalculateTotals();
            }
        });
    ...
    public function calculateAndSetValues()
    {
        ...
        // Only calculate item VAT if quotation is item-based
        if ($this->purchaseQuotation?->vat_base === 'item_vat') {
